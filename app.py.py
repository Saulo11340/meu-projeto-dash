...
import joblib
import numpy as np
from scipy.optimize import minimize  # Para otimização numérica
...
app.layout = html.Div([
    # Título
    html.H1("Otimização de Recursos Públicos Orçamentários", style={'textAlign': 'center'}),

    # Sliders e controles
    html.Div([
        html.H2("Ajuste de Alocação Orçamentária", style={'textAlign': 'center'}),
        html.Div([
            html.Div([
                html.Label(feature),
                dcc.Slider(
            ...
            ], style={'margin': '10px 0', 'width': '45%', 'display': 'inline-block'}) for feature in model_features
        ])
    ], style={'padding': '20px'}),

    # Botões de controle
    html.Div([
        html.Button('Aplicar Melhor Otimização', id='apply-optimization', n_clicks=0, style={'marginRight': '10px'}),
        html.Button('Restaurar Valores Médios', id='restore-average', n_clicks=0),
    ...
    # Legenda
    html.Div([
        html.H3("Legenda", style={'textAlign': 'center'}),
        html.Div([
            html.Div(style={'display': 'flex', 'align-items': 'center', 'marginBottom': '5px'}, children=[
                html.Div(style={'width': '20px', 'height': '20px', 'background-color': 'green', 'margin-right': '10px'}),
                html.P("Verde: PIB positivo")
            ]),
            html.Div(style={'display': 'flex', 'align-items': 'center', 'marginBottom': '5px'}, children=[
                html.Div(style={'width': '20px', 'height': '20px', 'background-color': 'red', 'margin-right': '10px'}),
                html.P("Vermelho: PIB negativo")
            ]),
            html.Div(style={'display': 'flex', 'align-items': 'center', 'marginBottom': '5px'}, children=[
                html.Div(style={'width': '20px', 'height': '20px', 'background-color': 'blue', 'margin-right': '10px'}),
                html.P("Azul: Inflação negativa (boa)")
            ]),
            html.Div(style={'display': 'flex', 'align-items': 'center', 'marginBottom': '5px'}, children=[
                html.Div(style={'width': '20px', 'height': '20px', 'background-color': 'orange', 'margin-right': '10px'}),
                html.P("Laranja: Inflação positiva (ruim)")
            ]),
            html.Div(style={'display': 'flex', 'align-items': 'center', 'marginBottom': '5px'}, children=[
                html.Div(style={'width': '20px', 'height': '20px', 'background-color': 'purple', 'margin-right': '10px'}),
                html.P("Roxo: Redução do Índice Gini (boa)")
            ]),
            html.Div(style={'display': 'flex', 'align-items': 'center', 'marginBottom': '5px'}, children=[
                html.Div(style={'width': '20px', 'height': '20px', 'background-color': 'yellow', 'margin-right': '10px'}),
                html.P("Amarelo: Aumento do Índice Gini (ruim)")
            ]),
